...
var Tween = {
	linear: function linear(b, c, d, t) {
		return c * t / d + b;
	},
	easeIn: function easeIn(b, c, d, t) {
		return c * (t /= d) * t + b;
	},
	easeOut: function easeOut(b, c, d, t) {
		return -c * (t /= d) * (t - 2) + b;
	},
	easeBoth: function easeBoth(b, c, d, t) {
		if ((t /= d / 2) < 1) {
			return c / 2 * t * t + b;
		}
		return -c / 2 * (--t * (t - 2) - 1) + b;
	},
	easeInStrong: function easeInStrong(b, c, d, t) {
		return c * (t /= d) * t * t * t + b;
	},
	easeOutStrong: function easeOutStrong(b, c, d, t) {
		return -c * ((t = t / d - 1) * t * t * t - 1) + b;
	},
	easeBothStrong: function easeBothStrong(b, c, d, t) {
		if ((t /= d / 2) < 1) {
			return c / 2 * t * t * t * t + b;
		}
		return -c / 2 * ((t -= 2) * t * t * t - 2) + b;
	},
	elasticIn: function elasticIn(b, c, d, t, a, p) {
		if (t === 0) {
			return b;
		}
		if ((t /= d) == 1) {
	...
	elasticOut: function elasticOut(b, c, d, t, a, p) {
		if (t === 0) {
			return b;
		}
		if ((t /= d) == 1) {
	...
	elasticBoth: function elasticBoth(b, c, d, t, a, p) {
		if (t === 0) {
			return b;
		}
		if ((t /= d / 2) == 2) {
	...
	backIn: function backIn(b, c, d, t, s) {
		if (typeof s == 'undefined') {
			s = 1.70158;
		}
		return c * (t /= d) * t * ((s + 1) * t - s) + b;
	},
	backOut: function backOut(b, c, d, t, s) {
		if (typeof s == 'undefined') {
			s = 3.70158; //回缩的距离
		}
		return c * ((t = t / d - 1) * t * ((s + 1) * t + s) + 1) + b;
	},
	backBoth: function backBoth(b, c, d, t, s) {
		if (typeof s == 'undefined') {
			s = 1.70158;
		}
		if ((t /= d / 2) < 1) {
	...
	bounceIn: function bounceIn(b, c, d, t) {
		return c - Tween['bounceOut'](d - t, 0, c, d) + b;
	},
	bounceOut: function bounceOut(b, c, d, t) {
		if ((t /= d) < 1 / 2.75) {
	...
	bounceBoth: function bounceBoth(b, c, d, t) {
		if (t < d / 2) {
