...
function swiCard() {
    var Tabs = function () {
        ...
        var moveTabs = function moveTabs(a) {
            var transY,
                scale;
            if (a) {
                tabs.css({'opacity': '1', 'box-shadow': '0 30px 60px rgba(0,0,0,0.4)', 'cursor': 'pointer'});
        ...
        var switchTabs = function switchTabs() {
            ...
            if (toggled) {
                ...
                tabs.css({'box-shadow': '0 30px 60px rgba(0,0,0,0.4)', 'cursor': 'default'});
                toggled = false;
...
function skewDeg() {
    ...
    $('.music .bg').on('mouseover', function () {
        ...
        // $('.m-boardT').animate({     left:'-105%', },500); $('.m-boardB').animate({
        //   left:'105%', })
    });
    $('.music .bg').on('mouseout', function () {
        ...
        // $('.m-boardT').animate({     left:'-100%', },500); $('.m-boardB').animate({
        //   left:'100%', })
    });
}
...
function replacePath() {
    $('.arrow-link')
        .on('mouseover', function () {
            $('.circle').attr("d", "M2560 1034l-2048 0 C229.717333 1034 0 804.282667 0 522 0 239.679407 229.717333 1" +
                    "0 512 10l2048 0C2842.358519 10 3072 239.679407 3072 522 3072 804.282667 2842.358" +
                    "519 1034 2560 1034z");
            $('.arrow').attr("d", "M2395 522l350 0M2645 422l100 100l-100 100");
        });
    $('.arrow-link').on('mouseout', function () {
        $('.circle').attr("d", "M512 1034l-0 0 C229.717333 1034 0 804.282667 0 522 0 239.679407 229.717333 10 51" +
                "2 10l0 0C794.358519 10 1024 239.679407 1024 522 1024 804.282667 794.358519 1034 " +
                "512 1034z");
